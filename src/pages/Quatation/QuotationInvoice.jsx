...
const QuotationInvoice = () => {
  ...
  const handleDownloadPDF = async () => {
    try {
      ...
      autoTable(doc, {
        body: [
          ["Company Name", quotation.clientName || "—", "Executive Name", quotation.executivename || "—"],
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '20px', fontSize: '13px' }}>
          <tbody>
            <tr>
              ...
              <td style={{ border: '1px solid #ccc', padding: '6px', fontWeight: 600 }}>Executive Name</td><td style={{ border: '1px solid #ccc', padding: '6px' }}>{quotation.executivename}</td>
            </tr>
            <tr>
          ...
          <tbody>
            {items.map((product, idx) => (
              <tr key={idx}>
                ...
                {/* {console.log(`"${product.ProductIcon}"`)} */}
